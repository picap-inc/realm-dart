...
#endif
        // Support 16KB pages for Android 15 compatibility
        // Validate page size is a power of 2 and at least 4KB
        REALM_ASSERT(size > 0);
        REALM_ASSERT((size & (size - 1)) == 0); // Must be power of 2
        REALM_ASSERT(size >= c_min_supported_page_size); // At least 4KB
